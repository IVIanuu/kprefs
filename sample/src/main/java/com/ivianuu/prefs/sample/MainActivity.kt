...
package com.ivianuu.prefs.sample
...
import com.ivianuu.prefs.coroutines.receiveChannel
import com.ivianuu.prefs.lifecycle.addListener
import com.ivianuu.prefs.lifecycle.liveData
import com.ivianuu.prefs.rx.observable
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        checkbox.setOnCheckedChangeListener { _, isChecked -> myPref.value = isChecked }
    }
