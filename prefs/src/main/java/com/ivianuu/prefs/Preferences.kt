 ...
 * Preferences
 */
class Preferences private constructor(private val sharedPreferences: SharedPreferences) {
    ...
    fun clear() {
        sharedPreferences.edit().clear().apply {
            if (PreferencesPlugins.useCommit) {
                commit()
            } else {
                apply()
            }
    ...
    companion object {
        ...
        /**
         * Returns a new [Preferences] instance which uses [sharedPreferences] internally
         */
        operator fun invoke(sharedPreferences: SharedPreferences) =
                Preferences(sharedPreferences)

        /**
         * Returns a new [Preferences] instance which uses the default [SharedPreferences]
         */
